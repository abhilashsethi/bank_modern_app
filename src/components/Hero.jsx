	...
	return (
		<section id="home" className={`flex md:flex-row flex-col`}>
			...
			>
				...
				<h1 className="font-poppins font-semibold ss:text-[68px] text-52px text-white ss:leading-[80px] leading-[60px] w-full">
					Payment Method.
				</h1>
			...
			<div>
				<img
					src={robot}
					alt="billing"
					className="w-[60%] h-[60%] relative z-index-[5]"
				/>
				<div className="absolute z-[0] w-[20%] h-[35%] top-0 pink__gradient"></div>
